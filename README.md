...
1. Download the latest bootstrap release from [https://github.com/dkneisz/k2-improvements/releases](https://github.com/dkneisz/k2-improvements/releases) and extract the folder.
